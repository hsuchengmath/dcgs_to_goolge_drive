...
class Data_Process:
    ...
    def load_data(self):
        ...
        self.review_data = pd.read_csv('data/review_BETA_Jan.csv', encoding='utf-8-sig')
    ...
    def build_interaction_feature_and_add_to_rating_data_UF(self, rating_review_data_with_UF, rating_data_with_UF):
        ...
        return mat_individual_col, mat_individual_dat, rating_matF_data
    ...
    def main(self):
        ...
        self.user_data, self.user_data_with_it = self.fillna_in_user_data(self.user_data)
        ...
        self.mat_individual_col, self.mat_individual_dat, self.rating_matF_data = self.build_interaction_feature_and_add_to_rating_data_UF(self.rating_review_data_with_UF, self.rating_data_with_UF)
        ...
        self.feature_list = list(self.train_data_AD_wo_label.columns)
